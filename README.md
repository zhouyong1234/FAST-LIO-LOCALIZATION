...
基于已知地图的定位，采用FAST-LIO建立点云地图，采用FAST-LIO的odometry为ndt匹配提供初始位姿，当前点云和地图匹配得到当前位姿，修正map->odom的变换关系，由map->odom * odom->base = map->base，为下一次ndt匹配提供初始位姿，采用[UrbanNavDataset](https://github.com/weisongwen/UrbanNavDataset)进行验证
...
![](result/FAST_LIO_LOCALIZATION.png)
